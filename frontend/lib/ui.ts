// Shared Tailwind class strings so form sections stay visually consistent.
export const box =
  'w-full border rounded px-3 py-2 mb-2 bg-white dark:bg-slate-700 dark:border-slate-600';
export const btn =
  'px-4 py-2 rounded bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400 text-white dark:text-slate-900 font-medium';
